...
export const ADMIN_NAV = [
  ...
  },
  {
    ...
    label: 'Vie Scolaire',
    items: [
      { path: '/admin/eleves', icon: GraduationCap, labelKey: 'eleves', module: 'eleves', primary: true, roles: ['directeur', 'directeur_etudes', 'secretaire', 'surveillant'] },
      { path: '/admin/classes', icon: School, labelKey: 'classes', module: 'classes', roles: ['directeur', 'directeur_etudes', 'secretaire'] },
      { path: '/admin/inscriptions', icon: ClipboardList, labelKey: 'inscriptions', module: 'inscriptions', primary: true, roles: ['directeur', 'directeur_etudes', 'secretaire'] },
      { path: '/admin/matieres', icon: BookOpen, labelKey: 'matieres', roles: ['directeur', 'directeur_etudes', 'secretaire'] },
      { path: '/admin/enseignants', icon: UserRound, labelKey: 'enseignants', module: 'personnel', roles: ['directeur', 'directeur_etudes', 'secretaire'] },
      { path: '/admin/emploi-du-temps', icon: CalendarDays, labelKey: 'emploi_du_temps', module: 'emploiDuTemps', roles: ['directeur', 'directeur_etudes', 'secretaire', 'surveillant'] },
      { path: '/admin/salles', icon: DoorOpen, labelKey: 'salles', module: 'emploiDuTemps', roles: ['directeur', 'directeur_etudes', 'secretaire'] },
  ...
  },
  {
    groupKey: 'analyse',
    items: [
      { path: '/admin/rapports', icon: BarChart3, labelKey: 'rapports', module: 'rapports', roles: ['directeur'] },
      { path: '/admin/personnel', icon: Users, labelKey: 'personnel', module: 'personnel', roles: ['directeur'] },
    ],
  },
  {
...
export const ENSEIGNANT_NAV = [
  {
    ...
    items: [
      ...
      { path: '/enseignant/mes-classes', icon: School, labelKey: 'mes_classes', module: 'classes', primary: true },
      { path: '/enseignant/saisie-notes', icon: ClipboardEdit, labelKey: 'saisie_notes', module: 'notes', primary: true },
      { path: '/enseignant/appel', icon: CalendarCheck, labelKey: 'faire_appel', module: 'presences', primary: true },
      { path: '/enseignant/mon-emploi', icon: CalendarDays, labelKey: 'mon_emploi', module: 'emploiDuTemps' },
...
export const PARENT_NAV = [
  {
    ...
    items: [
      ...
      { path: '/parent/mes-enfants', icon: Users, labelKey: 'mes_enfants', module: 'parents', primary: true },
      { path: '/parent/bulletins', icon: FileText, labelKey: 'bulletins', module: 'bulletins', primary: true },
