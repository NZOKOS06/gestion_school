...
import { LayoutDashboard, ShoppingCart, FileText, LogOut, Menu, Pill, ChevronRight, Bell } from 'lucide-react';
...
const NAV_ITEMS = [
  {
    groupKey: 'espace_vendeur',
    items: [
      { path: '/staff/dashboard', icon: LayoutDashboard, labelKey: 'dashboard' },
      { path: '/staff/vente', icon: ShoppingCart, labelKey: 'nouvelle_vente' },
      { path: '/staff/mes-ventes', icon: ShoppingCart, labelKey: 'mes_ventes' },
      { path: '/staff/ordonnance', icon: FileText, labelKey: 'scan_ordonnance' },
    ],
  },
];
...
function filArianeDepuisChemin(pathname) {
  const map = {
    ...
    ordonnance: 'Scan ordonnance',
  };
  const segments = pathname.replace('/staff/', '').split('/');
  return [
