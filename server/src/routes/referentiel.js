...
const generateRoles = ['directeur', 'directeur_etudes'];
...
router.post('/periodes/batch', authenticate, requireRole(...writeRoles), requireTenantMatch, ctrl.upsertPeriodesBatch);
router.delete('/periodes/:id', authenticate, requireRole('directeur', 'directeur_etudes'), requireTenantMatch, ctrl.deletePeriode);
router.post('/calendrier/generate-from-periodes', authenticate, requireRole(...generateRoles), requireTenantMatch, ctrl.generateCalendrierFromPeriodes);
