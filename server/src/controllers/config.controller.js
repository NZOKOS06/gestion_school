  ...
  try {
    ...
    const payload = withCdnImages({
      ...
      modules: {
        ...
        presences: cfg?.modulePresences ?? false,
        absences: cfg?.modulePresences ?? false,
        paiements: cfg?.modulePaiements ?? true,
        emploiDuTemps: cfg?.moduleEmploiDuTemps ?? false,
        salles: cfg?.moduleEmploiDuTemps ?? false,
        parents: cfg?.moduleParents ?? false,
        sanctions: cfg?.moduleSanctions ?? false,
        certificats: cfg?.moduleCertificats ?? false,
