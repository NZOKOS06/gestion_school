...
-- CreateEnum
CREATE TYPE "CycleEnseignement" AS ENUM ('prescolaire', 'primaire', 'college', 'lycee');

-- CreateEnum
CREATE TYPE "StatutInscription" AS ENUM ('en_attente', 'validee', 'annulee', 'suspendue');

-- CreateEnum
CREATE TYPE "StatutEcheance" AS ENUM ('en_attente', 'payee', 'en_retard', 'annulee');

-- CreateEnum
CREATE TYPE "TypeEvaluation" AS ENUM ('devoir', 'interrogation', 'examen', 'rattrapage');

-- CreateEnum
CREATE TYPE "MentionBulletin" AS ENUM ('felicitations', 'tableau_honneur', 'encouragements', 'avertissement_travail', 'avertissement_conduite', 'aucune');
...
-- CreateEnum
CREATE TYPE "TypeCertificat" AS ENUM ('scolarite', 'inscription', 'fin_etudes', 'autre');

-- CreateEnum
CREATE TYPE "TypeNotification" AS ENUM ('note', 'absence', 'sanction', 'paiement', 'bulletin', 'actualite', 'systeme');

-- CreateEnum
CREATE TYPE "AuditAction" AS ENUM ('login', 'logout', 'staff_created', 'staff_updated', 'staff_deleted', 'tenant_created', 'tenant_updated', 'eleve_created', 'eleve_updated', 'inscription_created', 'note_saisie', 'note_modifiee', 'bulletin_genere', 'paiement_encaisse', 'absence_saisie', 'sanction_attribuee', 'certificat_genere', 'password_changed');
...
CREATE TABLE "Bulletin" (
    ...
    "mention" "MentionBulletin" NOT NULL DEFAULT 'aucune',
...
-- CreateIndex
CREATE INDEX "Classe_cycle_idx" ON "Classe"("cycle");
...
-- CreateIndex
CREATE INDEX "EnseignantClasse_tenantId_idx" ON "EnseignantClasse"("tenantId");

-- CreateIndex
CREATE INDEX "EnseignantClasse_classeId_idx" ON "EnseignantClasse"("classeId");

-- CreateIndex
CREATE INDEX "EnseignantClasse_matiereId_idx" ON "EnseignantClasse"("matiereId");

-- CreateIndex
CREATE UNIQUE INDEX "EnseignantClasse_enseignantId_classeId_matiereId_key" ON "EnseignantClasse"("enseignantId", "classeId", "matiereId");
...
-- CreateIndex
CREATE INDEX "Evaluation_anneeScolaireId_idx" ON "Evaluation"("anneeScolaireId");
...
-- CreateIndex
CREATE INDEX "Bulletin_classeId_idx" ON "Bulletin"("classeId");

-- CreateIndex
CREATE INDEX "Bulletin_anneeScolaireId_idx" ON "Bulletin"("anneeScolaireId");
...
-- CreateIndex
CREATE INDEX "EmploiDuTemps_jourSemaine_idx" ON "EmploiDuTemps"("jourSemaine");
...
-- CreateIndex
CREATE INDEX "Certificat_tenantId_idx" ON "Certificat"("tenantId");

-- CreateIndex
CREATE INDEX "Certificat_eleveId_idx" ON "Certificat"("eleveId");

-- CreateIndex
CREATE INDEX "Certificat_type_idx" ON "Certificat"("type");

-- CreateIndex
CREATE UNIQUE INDEX "Certificat_tenantId_numeroSerie_key" ON "Certificat"("tenantId", "numeroSerie");
...
-- AddForeignKey
ALTER TABLE "EnseignantClasse" ADD CONSTRAINT "EnseignantClasse_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "EnseignantClasse" ADD CONSTRAINT "EnseignantClasse_matiereId_fkey" FOREIGN KEY ("matiereId") REFERENCES "Matiere"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Echeance" ADD CONSTRAINT "Echeance_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Note" ADD CONSTRAINT "Note_saisiParId_fkey" FOREIGN KEY ("saisiParId") REFERENCES "Staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Absence" ADD CONSTRAINT "Absence_saisieParId_fkey" FOREIGN KEY ("saisieParId") REFERENCES "Staff"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Paiement" ADD CONSTRAINT "Paiement_echeanceId_fkey" FOREIGN KEY ("echeanceId") REFERENCES "Echeance"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "Certificat" ADD CONSTRAINT "Certificat_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "Tenant"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Certificat" ADD CONSTRAINT "Certificat_eleveId_fkey" FOREIGN KEY ("eleveId") REFERENCES "Eleve"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Certificat" ADD CONSTRAINT "Certificat_anneeScolaireId_fkey" FOREIGN KEY ("anneeScolaireId") REFERENCES "AnneeScolaire"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Certificat" ADD CONSTRAINT "Certificat_delivreParId_fkey" FOREIGN KEY ("delivreParId") REFERENCES "Staff"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
